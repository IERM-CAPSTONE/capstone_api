...
import { DeleteExamTypeHandler } from './delete-exam-type.handler';

@ApiTags('ExamTypes')
@ApiBearerAuth('JWT-auth')
@Controller('exam-types')
@UseGuards(JwtAuthGuard, RolesGuard)
export class DeleteExamTypeEndpoint {
    constructor(private readonly handler: DeleteExamTypeHandler) { }
